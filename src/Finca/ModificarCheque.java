 ...
 * @author User
 */
public class ModificarCheque extends javax.swing.JFrame {
    ...
    public ModificarCheque() {
        ...
        try {
                ...
                Logger.getLogger(ModificarCheque.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButtonListo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 550, 230, 60));
        ...
        getContentPane().add(MostrarCodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 470, 40, 30));
        ...
        getContentPane().add(jLabelId, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 470, 100, 30));
        ...
        getContentPane().add(jTextFieldPrecio, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 420, 280, -1));
        ...
        getContentPane().add(jLabelPrecio3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 420, 110, -1));
        ...
        getContentPane().add(jLabelNombres1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 250, 110, -1));
        ...
        getContentPane().add(jComboBoxPredio, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 250, 250, 40));
        ...
        getContentPane().add(jLabelPrecio1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 360, 100, -1));
        ...
        getContentPane().add(jTextFieldFecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 310, 240, -1));
        ...
        getContentPane().add(jLabelPrecio2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 310, 100, -1));
        ...
        getContentPane().add(jTextFieldCantidadLitros, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 360, 280, -1));
        ...
        getContentPane().add(jLabelPrecio4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 530, 110, -1));

        jTextFieldPrecio1.setFont(new java.awt.Font("SansSerif", 0, 24)); // NOI18N
        jTextFieldPrecio1.setText("0");
        jTextFieldPrecio1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextFieldPrecio1ActionPerformed(evt);
            }
        });
        jTextFieldPrecio1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextFieldPrecio1KeyTyped(evt);
            }
        });
        getContentPane().add(jTextFieldPrecio1, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 530, 280, -1));
    ...
    private void jButtonListoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonListoActionPerformed
        if(jTextFieldFecha.getText().isEmpty()){
        ...
        }else if(jLabelId.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "No seleccionó un cheque de la lista");
        }
            ...
            try {
                con = DriverManager.getConnection(url, user, clave);
                stmt = con.createStatement();
                stmt.executeUpdate("UPDATE cheque SET predio = '"+jComboBoxPredio.getSelectedItem().toString()+"' , "
                        + "fecha = '"+jTextFieldFecha.getText()+"' , "
                        + " precio = '"+jTextFieldPrecio.getText()+"' ,"
                        + " cantidad = '"+jTextFieldCantidadLitros.getText()+"' , "
                        + " total = '"+total+"'");
            } catch (SQLException ex) {
                Logger.getLogger(ModificarCheque.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void jTextFieldPrecio1KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldPrecio1KeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextFieldPrecio1KeyTyped
    ...
    private void jButtonListo1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonListo1ActionPerformed
        if(jTextFieldFecha.getText().isEmpty()){
            ...
            try {
                con = DriverManager.getConnection(url, user, clave);
                stmt = con.createStatement();
                stmt.executeUpdate("DELETE FROM cheque WHERE id = '"+jLabelId.getText()+"'");
            } catch (SQLException ex) {
                Logger.getLogger(ModificarCheque.class.getName()).log(Level.SEVERE, null, ex);
            }
            
            JOptionPane.showMessageDialog(null, "Cheque eliminado");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarCheque.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarCheque().setVisible(true);
            }
        });
    }
